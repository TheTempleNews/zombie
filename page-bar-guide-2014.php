...
<div id="content" class="bar-guide-2014 bar-guide-2014-archive has-banner clearfix">

	<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
		<header id="page-header">
			<div class="special-issue-text-banner-container wrap clearfix">
				<h2 class="bar-guide-2014-text-banner special-issue-text-banner headline fittext"><a href="<?php echo home_url(); ?>/bar-guide-2014/"><?php the_title(); ?></a></h2>
			</div>
