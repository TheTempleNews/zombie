							...
							<?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
										...
										<article id="post-<?php the_ID(); ?>" <?php post_class( 'clearfix' ); ?> role="article">
											...
											<header>
												...
												<p class="byline"><i><?php _e("by", "zombietheme"); ?></i> <span class="authors sc"><?php if(function_exists('coauthors')) coauthors(); else the_author(); ?></span> | <time class="sc" datetime="<?php echo the_time('c'); ?>" pubdate><?php the_time('d F Y'); ?></time>
											</header>
