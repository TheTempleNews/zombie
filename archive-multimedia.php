				    ...
				    <h1 class="archive-main-title" class="first last twelvecol"><?php post_type_archive_title(); ?>
						...
						if ( !is_paged() ) { ?>
								...
								<div id="multimedia-mgallery" class="mgallery ninecol last clearfix">
									...
									<div id="post-type-loop-top" class="multimedia-mgallery-top twelvecol first last clearfix">
										...
										if ( $firstpost == 'firstpost' ) { ?>
											...
											<article id="post-<?php the_ID(); ?>" <?php post_class( 'twelvecol first last clearfix' ); ?> role="article">
												...
												<header class="clearfix">
													...
													<h1 class="multimedia-headline multimedia-top-headline headline top-headline"><a href="<?php the_permalink() ?>" rel="bookmark" title="<?php the_title_attribute(); ?>"><?php the_title(); ?></a></h1>
													<p class="multimedia-byline byline"><i><?php _e("by", "zombietheme"); ?></i> <span class="multimedia-authors authors"><?php if(function_exists('coauthors_posts_links')) coauthors_posts_links(); else the_author_posts_link(); ?></span> <time class="sc" datetime="<?php echo the_time('c'); ?>" pubdate><?php echo ttn_article_published_link(); ?></time>
												</header>
											...
											$firstpost = '';
												...
												<article id="post-<?php the_ID(); ?>" <?php post_class( 'fourcol clearfix ' . $k ); ?> role="article">
													<a href="<?php the_permalink(); ?>" class="article-link" style="display: block;">
														...
														<header>
															<div class="post-category-list-container"><?php // the_category_but( $cat_id ); ?></div>
															<h1 class="multimedia-headline headline"><?php the_title(); ?></h1>
															<p class="multimedia-byline byline"><i><?php _e("by", "zombietheme"); ?></i> <span class="multimedia-authors authors"><?php if(function_exists('coauthors')) coauthors(); else the_author(); ?></span> <time class="sc" datetime="<?php echo the_time('c'); ?>" pubdate><?php echo get_the_time( 'd F Y' ); ?></time>
														</header>
						...
						<?php if ( is_paged() ){ ?>
								...
								<div id="multimedia-mgallery" class="mgallery eightcol last clearfix">
