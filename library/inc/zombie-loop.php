...
function the_zombie_loop( $ttn_section, $show_posts = 5 ) {
  ...
  ********************/
  if ( is_front_page() ) :
    ...
    ?>
      <h2 id="<?php echo $ttn_section; ?>-section-box-title" class="pane__title  section-box-title"><a href="<?php echo esc_url(site_url() . '/' . $ttn_section . '/'); ?>"><?php echo $cat_name; ?></a></h2>
      <?php
      // ZOMBIE SWARM!
    ...
    /* OPINION SECTION (HOZ) */
    if ( $post_type == 'article_opinion' ) { ?>
      <h2 class="pane__title  section-box-title"><a href="<?php echo esc_url(site_url() . '/' . $ttn_section); ?>"><?php echo $cat_name; ?></a></h2>
      <?php
