<?php get_header(); ?>
			...
			<div id="content">
				...
				<div id="inner-content" class="wrap clearfix">
						...
						<div id="media-container" class="section-container first last" role="featured">
						...
						<!-- NEWS SECTION -->
						<section id="section-box-news" class="section-container section-box sixcol first clearfix">
						...
						<!-- DESKTOP-ONLY ADS -->
						<?php if ( !is_handheld() ) : ?>
						<div class="ad-container sixcol last">
						...
						<!-- LIVING SECTION -->
						<section id="section-box-living" class="section-container section-box sixcol last clearfix">
						...
						<!-- DESKTOP-ONLY ADS -->
						<?php if ( !is_handheld() ) : ?>
						<div class="advert-container sixcol last">
							<div class="advert banner-ad twelvecol first last">
								<!-- put a dumb ad here -->
							</div>
						</div>

						<div class="advert-container sixcol first">
							<div class="advert banner-ad twelvecol first last">
								<!-- put a dumb ad here -->
							</div>
						</div>
						...
						<!-- MULTIMEDIA SECTION -->
						<section id="section-box-multimedia" class="section-box section-container twelvecol first last">
						...
						<section id="section-box-print-carousel" class="clearfix section-box section-container first last">
							<h2 class="section-box-title">Print Edition</h2>
