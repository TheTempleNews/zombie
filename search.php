            ...
            <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
              ...
              <article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article">
                ...
                <header class="article-header">
                  ...
                  <p class="meta"><?php _e("Posted", "zombietheme"); ?> <time datetime="<?php echo the_time('Y-m-j'); ?>" pubdate><?php the_time('F jS, Y'); ?></time> <?php _e("by", "zombietheme"); ?> <?php the_author_posts_link(); ?> <span class="amp">&</span> <?php _e("filed under", "zombietheme"); ?> <?php the_category(', '); ?>.</p>
            ...
            <?php endwhile; ?>
              ...
              <?php else : ?>
                  ...
                  <article id="post-not-found" class="hentry clearfix">
                    <header class="article-header">
                      <h1><?php _e("Sorry, No Results.", "zombietheme"); ?></h1>
                    </header>
                    <section class="post-content">
                      <p><?php _e("UTry your search again.", "zombietheme"); ?></p>
                    </section>
                    <footer class="article-footer">
                        <p><?php _e("This is the error message in the search.php template.", "zombietheme"); ?></p>
                    </footer>
                  </article>
