			...
			<div id="content">
				...
				<div id="inner-content" class="wrap clearfix">
				    ...
				    <div id="main" class="eightcol first clearfix" role="main">
					    ...
					    <h1 class="archive-title h2"><span><?php _e("Posts Categorized:", "zombietheme"); ?></span> <?php single_cat_title(); ?></h1>
					    ...
					    <?php else : ?>
        					...
        					<article id="post-not-found" class="hentry clearfix">
        						...
        						<footer class="article-footer">
        						    <p><?php _e("This is the error message in the taxonomy-custom_cat.php template.", "zombietheme"); ?></p>
        						</footer>
        					</article>
