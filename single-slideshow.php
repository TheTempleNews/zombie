			...
			<div id="content">
				...
				<div id="inner-content" class="wrap clearfix">
					...
					<div id="main" class="twelvecol first last clearfix" role="main">
						...
						<h1 class="single-section-name" class="first last twelvecol"><a href="<?php home_url(); ?>/slideshows">Slideshows</a></h1>
						...
						<?php if (have_posts()) : while (have_posts()) : the_post(); ?>
							...
							<article id="post-<?php the_ID(); ?>" <?php post_class('clearfix'); ?> role="article" itemscope itemtype="http://schema.org/BlogPosting">
								...
								<header class="article-header">
									...
									<section class="dek">
										<p><?php echo get_field($post->ID, 'media_dek', true); ?></p>
									</section> <!-- end dek -->
								...
								<section class="post-content clearfix" itemprop="articleBody">
									...
									<div class="single-slideshow single-mgallery">
										<?php the_content(); ?>
									</div>
									
									<div class="single-slideshow-summary single-media-summary">
