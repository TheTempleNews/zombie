...
function zombie_scripts() {
  ...
  wp_enqueue_style('zombie-main', get_stylesheet_directory_uri() . '/assets/css/main.min.css', array(), 'e2ab67438d0337cc5f0b44b87912a8b6');
  ...
  wp_register_script('zombie-scripts', get_stylesheet_directory_uri() . '/assets/js/scripts.min.js', false, '502e527d15ba9fb43a2fedc3a959af21', true);
