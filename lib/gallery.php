...
if (current_theme_supports('zombie-gallery')) {
  remove_shortcode('gallery');
  add_shortcode('gallery', 'zombie_gallery');
 ...
 */
function zombie_attachment_link_class($html) {
  $postid = get_the_ID();
  $html = str_replace('<a', '<a class="thumbnail img--thumbnail"', $html);
  return $html;
}
add_filter('wp_get_attachment_link', 'zombie_attachment_link_class', 10, 1);

/**
 * Wrap embedded videos with `.video-container`.
 *
