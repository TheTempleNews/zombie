 ...
 */
function zombie_root_relative_url($input) {
...
if (zombie_enable_root_relative_urls()) {
  ...
  add_filters($root_rel_filters, 'zombie_root_relative_url');
}
